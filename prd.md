...
`id, agent_id UNIQUE, password_hash, name, role('admin' | 'agent'), can_create, can_edit, can_delete, can_export, created_at, last_login_at, sessions_invalidated_at, last_seen_at`
